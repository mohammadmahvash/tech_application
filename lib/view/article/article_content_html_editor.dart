...
class ArticleContentHtmlEditor extends StatefulWidget {
  const ArticleContentHtmlEditor({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  ArticleContentHtmlEditorState createState() => ArticleContentHtmlEditorState();
}

class ArticleContentHtmlEditorState extends State<ArticleContentHtmlEditor> {
  String result = '';
